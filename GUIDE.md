...
**Хамгийн хялбар:** `run.bat` файл дээр **давхар товш**. Анхны удаа venv-ээ
автоматаар үүсгэж, багцуудыг суулгаад, GUI-г нээнэ. Дараагийн удаа шууд нээгдэнэ.
(PowerShell дуртай бол: баруун товш → *Run with PowerShell* эсвэл `./run.ps1`.)
